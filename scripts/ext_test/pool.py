...
Moi method ra mot file `results/ext_test/<cfg>/predictions/<Method>.dosage.csv.gz`
voi 4 cot `sample_id,fold,gene,allele,dosage` (fold luon la 91). Do la dinh dang
DUY NHAT ma `scripts/eval/cv10_canonical_metrics.py` doc, nen ca 5 method di qua
cung mot allele universe / bang AF / luat goi cung.

    python scripts/ext_test/pool.py vn1k_khv [--methods SNP2HLA HIBAG ...]
"""
