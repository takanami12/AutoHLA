...
khi gop -- `results/ext_test/diag2/BAO_CAO_TONG_HOP.md` muc 2).
...
vi gop them se xoa mot phan biet co that.
    ...
    python scripts/ext_test/make_ggroup_labels.py            # ca hai o
    python scripts/ext_test/make_ggroup_labels.py vn1k_khv
"""
